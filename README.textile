...
* Fixed a silly bug. I was validating some fields that I had removed from the UI, so bamboo would not let the user progress past the guthub page when creating a new repository. 
